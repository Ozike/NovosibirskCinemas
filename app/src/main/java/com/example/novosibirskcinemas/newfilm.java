...
//        lvMain.getCheckedItemPositions();
    ...
    class MyTaskTF extends AsyncTask<String, Void, Void > {
        ...
        protected Void doInBackground(String... params) {
            ...
            try {
                myConnection.getOutputStream().write(("id=3&IDcinema=" + params[0]+"&IDfilm="+params[1]).getBytes());
            } catch (IOException e) {
                e.printStackTrace();
            };
...
//            ID=result;
    ...
    class MyTask extends AsyncTask<Void, Void, ArrayList<String[]>>{
        ...
        protected ArrayList<String[]> doInBackground(Void... params) {
            ...
            HttpURLConnection myConnection = null;
            try {
                URL githubEndpoint = new URL("http://192.168.244.106:8080/kinogladunov?id=3");
                myConnection =
                        (HttpURLConnection) githubEndpoint.openConnection();
            } catch (MalformedURLException e) {
                e.printStackTrace();
