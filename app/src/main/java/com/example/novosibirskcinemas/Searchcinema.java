...
public class Searchcinema extends AppCompatActivity {
    TextView tvInfo;
    EditText tvName;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_searchcinema);
    ...
    class MyTask extends AsyncTask<String, Void, ArrayList<String[]>> {
        ...
        protected ArrayList<String[]> doInBackground(String... params) {
            ...
            try {
                URL mySite = new
                        URL("http://192.168.244.106:8080/kinogladunov?id=1&name="+params[0]);
                myConnection =
...
// sb.append("\r\n : " +value);
        ...
        protected void onPostExecute(ArrayList<String[]> result) {
            ...
            Searchcinema.ClAdapter clAdapter=new
                    Searchcinema.ClAdapter(tvInfo.getContext(),result);
            ListView lvMain = (ListView) findViewById(R.id.lvMain);
            lvMain.setAdapter(clAdapter);
            tvInfo.setText("Кинотеатры найдены");
        }
    }
