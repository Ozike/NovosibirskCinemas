...
public class findfilm extends AppCompatActivity {
    TextView tvInfo;
    EditText tvName;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_findfilm);
        tvInfo = (TextView) findViewById(R.id.tvInfo);
        tvName = (EditText) findViewById(R.id.editTextTextPersonName);
    }
    public void onclick(View v){
        findfilm.MyTask mt = new findfilm.MyTask();
    ...
    class MyTask extends AsyncTask<String,Void, ArrayList<String[]>> {
        ...
        protected ArrayList<String[]> doInBackground(String... params) {
            ...
            try {
                URL mySite = new URL("http://192.168.244.106:8080/kinogladunov?id=2&name="+params[0]);
        ...
        protected void onPostExecute(ArrayList<String[]> result){
            ...
            findfilm.ClAdapter clAdapter = new findfilm.ClAdapter(tvInfo.getContext(),result);
            ListView lvMain = (ListView) findViewById(R.id.lvMain);
            lvMain.setAdapter(clAdapter);
            tvInfo.setText("Фильмы найдены");
